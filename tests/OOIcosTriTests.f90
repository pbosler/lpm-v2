...
call LogMessage(exelog, TRACE_LOGGING_LEVEL, "IcosTriMeshTest part 1:", " build an icosahedral triangle sphere mesh.")
call LogMessage(exelog, TRACE_LOGGING_LEVEL, "IcosTriMeshTest part 2:", " test point query algorithm.")
call LogMessage(exeLog, TRACE_LOGGING_LEVEL, "IcosTriMeshTest part 3:", " test adjacency algorithms.")
call LogMessage(exelog, TRACE_LOGGING_LEVEL, "IcosTriMeshTest part 4:", " output to paraview/vtk.")

call mesh%init("icos_tri_sphere", initNest, initNest, amrLimit, sphRadius)
...
write(fname,'(A,I1,A)') "icosTriSphereTest", initNest, ".m"
...
write(fname,'(A,I1,A)') "icosTriSphereTest", initNest, ".vtp"
open(unit=WRITE_UNIT_1, file=trim(fname), action='write', status='replace')
